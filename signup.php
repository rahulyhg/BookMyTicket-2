...
<div class="container">
    <div class="row">
    <br>
        <form class="col s8 push-s2 center card" action="signup_check.php">
            <h3>Sign Up</h3>
            ...
            <input type="text" name="mobile" class="col s8 push-s2" placeholder="Mobile Number">
            <div class="col s12"></div>
            <select class="col s4 push-s4" name="gender">
